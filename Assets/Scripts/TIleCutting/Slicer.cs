...
namespace Assets.Scripts
{
    class Slicer
    {
        ...
        public static GameObject[] Slice(Plane plane, GameObject objectToCut)
        {
            ...
            positiveObject.transform.localScale = objectToCut.transform.lossyScale;
            GameObject negativeObject = CreateMeshGameObject(objectToCut);
            negativeObject.name = string.Format("{0}_negative", objectToCut.name);
            negativeObject.transform.localScale = objectToCut.transform.lossyScale;
            // positiveObject.GetComponent<Rigidbody>().useGravity=false;
            // positiveObject.GetComponent<Rigidbody>().constraints=RigidbodyConstraints.FreezeAll;
